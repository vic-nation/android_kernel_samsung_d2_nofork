...
#if defined(CONFIG_OPTICAL_TAOS_TRITON) || defined(CONFIG_INPUT_YAS_SENSORS)
...
static struct i2c_board_info msm_camera_board_info[] __initdata = {
...
{	/*KEY REV*/
	...
	if (system_rev < BOARD_REV03) {
		...
		sns_i2c_board_info[0].addr = 0x19;
	}
#endif
}
